...
class LicensePlateTemplates:
    def __init__(self):
        self.templates = {
            "armenian_type1": (r"^\d{2}[A-Z]{2}\d{3}$", "12AB345"),
            "armenian_type2": (r"^\d{3}[A-Z]{2}\d{2}$", "123AB45"),
            "russian_type1": (r"^[A-Z]\d{3}[A-Z]{2}\d{2}$", "A123BC45"),
            "russian_type2": (r"^[A-Z]\d{3}[A-Z]{2}\d{3}$", "A123BC123"),
            "russian_type3": (r"^[A-Z]{2}\d{3}[A-Z]\d{2}$", "AB123C45"),
            "russian_type4": (r"^[A-Z]{2}\d{3}[A-Z]\d{3}$", "AB123C456"),
